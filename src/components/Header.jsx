...
const Header = () => {
  ...
  return (
    <div className='flex justify-between items-center px-8  absolute top-0 left-0 w-full z-2 bg-gradient-to-b from-black'>
  ...
  <div className='mr-6 my-6 flex p-2'>
    ...
    {SUPPORTING_LANGUAGES.map((lan) => <option key={lan.SUPPORTING_LANGUAGES} value={lan.searchIdentifier}>{lan.searchLanguage} </option>)}
    </select>}
